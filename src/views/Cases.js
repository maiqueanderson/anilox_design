...
const Cases = () =>{
    return(
        <div className="my-5">
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image1} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image5} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image9} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image13} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image17} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image21} />
                </Col>
            ...
            <Row>
                <Col xs={12} lg={3}>
                <Image className="img-thumbnail fluid caseImage my-3" src={image25} />
                </Col>
